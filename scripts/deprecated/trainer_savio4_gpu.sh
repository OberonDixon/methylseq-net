...
CONFIG_FILES=(
    "../configs/train_seq-binary-drop8-cpg-decay_lightning.gin"
...
NCCL_P2P_DISABLE=1 python ../methylseqnet/train.py --config $CONFIG_FILE --unique_identifier $UNIQUE_IDENTIFIER