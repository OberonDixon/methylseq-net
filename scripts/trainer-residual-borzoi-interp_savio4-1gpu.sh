...
CONFIG_FILES=(
    "../configs/residual/interp/borzoi_pretrain_interp-methyl-local-only_multiply.gin"
    "../configs/residual/interp/borzoi_pretrain_interp_methylseq-residual_multiply.gin"
)
