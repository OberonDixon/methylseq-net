...
#SBATCH --array=6-8 # Specify the range of array jobs (e.g., 0-2 for 3 configs)
...
CONFIG_FILES=(
    ...
    "../configs/residual/subset_peaks/borzoi_residual-methylseq-basset_subset0cts.gin"
    "../configs/residual/subset_peaks/borzoi_residual-methylseq-basset_subset10cts.gin"
    "../configs/residual/subset_peaks/borzoi_residual-methylseq-basset_subset3cts-single.gin"
)
