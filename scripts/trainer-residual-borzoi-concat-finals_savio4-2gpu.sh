...
#SBATCH --array=0-11 # Specify the range of array jobs (e.g., 0-2 for 3 configs)
...
CONFIG_FILES=(
    ...
    "../configs/residual/concat_pretrained_embeddings/borzoi_residual-methylseq-basenji_concat-emb-final-add.gin"
...
CONFIG_FILE=${CONFIG_FILES[$((SLURM_ARRAY_TASK_ID % 6))]}
