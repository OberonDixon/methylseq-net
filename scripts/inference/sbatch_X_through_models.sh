#!/bin/bash
#SBATCH --job-name=X_inactivation_through_methylseq_2gpu
...
#SBATCH --array=0-14 # Specify the range of array jobs (e.g., 0-2 for 3 configs)
...
python run_X-inactivation_save_h5.py --model-identifier ${MODEL_IDENTIFIERS[$SLURM_ARRAY_TASK_ID]}