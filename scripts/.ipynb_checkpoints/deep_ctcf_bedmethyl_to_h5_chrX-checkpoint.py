...
datasets_dict = {
    ...
    f'/clusterfs/nilah/oberon/datasets/methylseq-net_deep-ctcf/chrX_ALL_th{track_threshold}_fd6d75e.h5':['chrX'],
}
...
for dataset_path,chromosomes in datasets_dict.items():
    ...
    for chromosome in chromosomes:
        ...
        for chunk_start in tqdm(range(0,min(contig_length-seq_length+1,early_stop),128)):
