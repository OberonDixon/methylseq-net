...
#SBATCH --array=0-1,5-6 # Specify the range of array jobs (e.g., 0-2 for 3 configs)

# Command(s) to run:
# Define an array of config files
CONFIG_FILES=(
    "../configs/residual/pretrain_head_only.gin"
    "../configs/residual/pretrain_methylseq-residual-60_multiply.gin"
    "../configs/residual/methylseq_only.gin"
    "../configs/residual/pretrain_methylseq-residual-288_multiply.gin"
    "../configs/residual/pretrain_seq-residual-60_multiply.gin"
    "../configs/residual/pretrain_methyl-residual-60_multiply.gin"
    "../configs/residual/pretrain_smoothed-methyl-residual-60_multiply.gin"
)
