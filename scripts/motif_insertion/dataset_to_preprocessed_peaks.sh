...
#     /global/scratch/projects/vector_streetslab/oberon/methylseqnet_manuscript_datasets/motif_insertion/fastas/motif_inserted_random_celltype_cpg.05-.15_10cts_peaks_2048 \
#     --INPUT_LEN 16384 \
#     --SHUFFLE_LEN 2048 \
#     --OVERWRITE
