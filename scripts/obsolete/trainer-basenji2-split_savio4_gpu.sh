...
CONFIG_FILES=(
    '../configs/split-basenji2/train-basenji55k-split-all_seq-cpg_transformed.gin'
    '../configs/split-basenji2/train-basenji55k-split-till-final_seq-cpg_transformed.gin'
    '../configs/split-basenji2/train-basenji55k-split-till-penultimate_seq-cpg_transformed.gin'
    '../configs/split-basenji2/train-basenji55k-split-till-dilated_seq-cpg_transformed.gin'
    '../configs/split-basenji2/train-basenji55k-split-till-tower_seq-cpg_transformed.gin'
)
