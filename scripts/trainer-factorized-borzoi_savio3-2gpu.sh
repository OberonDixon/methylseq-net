...
#SBATCH --array=16 # Specify the range of array jobs (e.g., 0-2 for 3 configs)
...
CONFIG_FILES=(
    ...
    "../configs/factorized/borzoi_factorized_dual-reps-tm1.0-methylseq-dilate7x2-multiply-7xFC-no-aux-losses.gin"
