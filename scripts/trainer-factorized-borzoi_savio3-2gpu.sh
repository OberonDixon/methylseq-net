...
#SBATCH --array=14,15 # Specify the range of array jobs (e.g., 0-2 for 3 configs)
#SBATCH --exclude=n0134.savio3,n0135.savio3,n0136.savio3,n0137.savio3,n0138.savio3,n0143.savio3,n0144.savio3,n0145.savio3,n0158.savio3,n0159.savio3,n0160.savio3,n0161.savio3,n0174.savio3,n0175.savio3,n0176.savio3,n0004.savio3,n0005.savio3
# Command(s) to run:
...
CONFIG_FILES=(
    ...
    "../configs/factorized/borzoi_factorized_dual-reps-tm1.0-methylseq-dilate7x2-multiply-no-aux-losses_6ds.gin"
    "../configs/factorized/borzoi_factorized_dual-reps-tm1.0-methyl-multiply-dilate7x2-no-aux-losses_6ds.gin"
...
NCCL_P2P_DISABLE=1 python ../methylseqnet/trainer.py --config $CONFIG_FILE --unique_identifier $UNIQUE_IDENTIFIER --batch_size 4 --logging-level DEBUG
