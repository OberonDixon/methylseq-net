    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for output_file in output_files:
            with h5py.File(output_file, 'r') as h5f:
                ...
                assert h5f['methylation'].shape[3] == expected_seq_length, f"Methylation length mismatch in {output_file}"
                assert h5f['methylation'].shape[2] % 3 == 0, f"Methylation channels dimension mismatch in {output_file}"
